...
The deployment url is: [https://arquisoft.github.io/wichat_es3c/](https://arquisoft.github.io/wichat_es3c/).
...
If we want to deploy it to GitHub pages, so it is accessible via [https://arquisoft.github.io/wichat_es3c/](https://arquisoft.github.io/wichat_es3c/), we need to execute `npm run deploy`.
